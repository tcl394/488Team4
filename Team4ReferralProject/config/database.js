...
module.exports = {
  ...
  postSurvey: function (q1answer, q2answer, q3answer, q4answer, referred_email){
    var makeString = format('INSERT INTO survey_response (q1answer, q2answer, q3answer, q4answer, referred_email) VALUES (\'%s\',\'%s\',\'%s\',\'%s\',\'%s\');', q1answer, q2answer, q3answer, q4answer, referred_email);
    console.log(makeString);
    var findUser = makeString.toString();
